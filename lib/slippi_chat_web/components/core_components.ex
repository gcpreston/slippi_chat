defmodule SlippiChatWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SlippiChatWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SlippiChatWeb.Gettext, "errors", msg, opts)
    end
  end
